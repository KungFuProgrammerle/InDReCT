...
class MHSIU(nn.Module):
    def __init__(self, in_dim, num_groups=4,num_zoom=3):
        ...
        # self.conv_lms = ConvBNReLU(in_dim, 3 * in_dim, 1)  # inter-branch
        self.initial_merge = ConvBNReLU(self.num_zoom * in_dim, 3 * in_dim, 1)  # inter-branch
        # self.initial_merge = ConvBNReLU( in_dim, 3 * in_dim, 1)  # inter-branch
        ...
        # self.catTrans=ConvBNReLU(in_dim, in_dim, 1, 1, 1)
        self.out = ConvBNReLU(3 * in_dim, in_dim, 1)
